...
public class ShipServiceImpl implements ShipService {
    ...
    @Override
    public Page<Ship> gelAllShips(Specification<Ship> specification, PageRequest sortedByName) {
        Page<Ship> page = shipRepository.findAll(specification, sortedByName);
        return page;
    }

    @Override
    public List<Ship> gelAllShips(Specification<Ship> specification) {
        List<Ship> list = shipRepository.findAll(specification);
        return list;
    }
